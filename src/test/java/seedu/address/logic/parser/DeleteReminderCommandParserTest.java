 ...
 * outside of the DeleteReminderCommand code. For example, inputs "1 1" and "1 1 abc" take the
...
public class DeleteReminderCommandParserTest {
    ...
    public void parse_validArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, "1 1", new DeleteReminderCommand(INDEX_FIRST_PERSON, INDEX_FIRST_PERSON));
    }
