...
* [2. Features](#2-features)
  * [2.1 General Commands](#21-general-commands)
    * [2.1.1 View Help](#211-viewing-help--help)
    * [2.1.2 Listing all Clients](#212-listing-all-clients--list)
    * [2.1.3 Clear all Entires](#213-clearing-all-entries-clear)
    * [2.1.4 Exiting the Program](#214-exiting-the-program--exit)
  * [2.2 Managing Clients](#22-managing-clients)
    * [2.2.1 Adding a Client](#221-adding-a-client--add)
    * [2.2.2 Deleting a Client](#222-deleting-a-client--delete)
    * [2.2.3 Editing a Client](#223-editing-a-client--edit)
    * [2.2.4 Locating a Client](#224-locating-clients-by-name--find)
    * [2.2.5 Staring a Client](#225-starring-a-client--star)
    * [2.2.6 Removing Star of a Client](#226-removing-star-status-of-a-client--unstar)
    * [2.2.7 Archiving a Client](#227-archiving-a-client--archive)
    * [2.2.8 Unarchiving a Client](#228-unarchiving-a-client--unarchive)
  * [2.3 Reminders](#23-reminders)
    * [2.3.1 Adding a Reminder](#231-adding-a-reminder--reminder)
    * [2.3.2 Deleting a Reminder](#232-deleting-a-reminder--rdelete)
    * [2.3.3 Editing a Reminder](#233-editing-a-reminder--redit)
  * [2.4 Meeting Notes](#24-meeting-notes)
    * [2.4.1 Adding a Meeting Note](#241-adding-a-meeting-note--note)
    * [2.4.2 Deleting a Meeting Note](#242-deleting-a-meeting-note--ndelete)
* [3. FAQ](#3-faq)
